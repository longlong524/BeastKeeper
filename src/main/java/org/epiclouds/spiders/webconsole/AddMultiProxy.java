...
public class AddMultiProxy extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * Default constructor.
	 */
	public AddMultiProxy() {
	...
	protected void doPost(HttpServletRequest request,
		...
		try{
			String proxy=request.getParameter("proxies");
			if(proxy==null||"".equals(proxy)){
				throw new Exception("proxies string is null!");
			}
			BufferedReader br=new BufferedReader(new StringReader(proxy));
			String line=null;
