...
public class ChannelManager implements Runnable{
	...
	public void addBPChnnelToFreeQueue(BPChannel ch){
		if(Thread.currentThread()==thisthread){
			...
			try {
				commandQue.put(new ChannelCommandBean(Command.AddBPChnnelToFreeQueue, new Object[]{ch}));
			} catch (InterruptedException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	...
	public void addBPChnnelToRecoverQueue(BPChannel ch){
		if(Thread.currentThread()==thisthread){
			...
			try {
				commandQue.put(new ChannelCommandBean(Command.AddBPChnnelToRecoverQueue, new Object[]{ch}));
			} catch (InterruptedException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	...
	public void putbackProxyToBackQueue(BPChannel channel,BPRequest request){
		if(Thread.currentThread()==thisthread){
			...
			try {
				commandQue.put(new ChannelCommandBean(Command.PutbackProxyToBackQueue, new Object[]{channel,request}));
			} catch (InterruptedException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	...
	public void removeBPChnnelFromFreeQueue(BPChannel ch){
		if(Thread.currentThread()==thisthread){
			...
			try {
				commandQue.put(new ChannelCommandBean(Command.RemoveBPChnnelFromFreeQueue, new Object[]{ch}));
			} catch (InterruptedException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	...
	public void removeBPChnnelFromRecoverQueue(BPChannel ch){
		if(Thread.currentThread()==thisthread){
			...
			try {
				commandQue.put(new ChannelCommandBean(Command.RemoveBPChnnelFromRecoverQueue, new Object[]{ch}));
			} catch (InterruptedException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
