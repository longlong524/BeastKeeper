...
function requestData(name) {
    $.ajax({
        ...
        success: function(point) {
        	...
        	var shift=cpuchart.series[0].data.length>10;

    		var entry=new Object();
    		var t=new Date();
    		entry.x=t.getTime();
    		entry.y=point.cpu;
    		cpuchart.series[0].addPoint(entry, false, shift); 
    		entry=new Object();
    		entry.x=t.getTime();
    		entry.y=point.mem;
    		memchart.series[0].addPoint(entry, false, shift); 
